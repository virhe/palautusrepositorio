...
class TestKauppa(unittest.TestCase):
    ...
    def test_tilisiirto_kutsutaan_oikeilla_tiedoilla(self):
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_varastossa_ja_loppuunmyyty(self):
        self.kauppa.lisaa_koriin(1)
    ...
    def test_kauppa_pyytaa_viitenumeron(self):
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
